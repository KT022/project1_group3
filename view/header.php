...
<head>
    ...
    <link rel="icon" href="./view/images/ccsslogo.svg" type="image/x-icon" />
</head>
...
<body>
    <header class="">
        <section class="flex items-center justify-between w-[75%] mx-auto py-5">
            <a href='index.php'>
                <img src="./view/images/ccsslogo.svg" alt="">
            </a>
            <section class="flex items-center gap-x-5">
                ...
                <a href="#">
                    <section
                        ...
                        <p class="text-[#EA2F38] font-sans font-[500] mx-3 ">Contact us
                        <p>
